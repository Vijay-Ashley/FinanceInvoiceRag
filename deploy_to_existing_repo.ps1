...
Write-Host "🚀 Deploying v4.0 to GitHub Repository" -ForegroundColor Cyan
...
Write-Host "⚠️  WARNING: This will replace ALL code in your GitHub repository!" -ForegroundColor Yellow
...
if (Test-Path ".git") {
    Write-Host "🗑️  Removing old git repository..." -ForegroundColor Yellow
...
Write-Host "⚠️  This will replace ALL code in the repository!" -ForegroundColor Yellow
Write-Host ""
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "   - Configure Git credentials: git config --global credential.helper wincred" -ForegroundColor Gray
    Write-Host ""
